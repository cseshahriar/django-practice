...
from .views import upload_file_view, upload_image_file, editjs_home_view, editjs_post_detail, grapperjs_home_view
...
urlpatterns = [
    ...
    # grapperjs
    path('editjs/grapperjs_home_view/', grapperjs_home_view, name='grapperjs_home_view'),
]